var resources = {
  ...
  icons: {
    ...
    quiklogo: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" ><defs><filter id="neonGlow" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur stdDeviation="3" result="blurred"/><feFlood flood-color="#00FFEC" result="glowColor"/><feComposite in="glowColor" in2="blurred" operator="in" result="glow"/><feMerge><feMergeNode in="glow"/><feMergeNode in="glow"/><feMergeNode in="SourceGraphic"/></feMerge></filter><linearGradient id="neonGradient" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#00D4FF"/><stop offset="100%" stop-color="#00FFEC"/></linearGradient></defs><circle cx="50" cy="50" r="40" stroke="#005566" stroke-width="8" fill="none"/><circle cx="50" cy="50" r="40" stroke="url(#neonGradient)" stroke-width="6" fill="none" filter="url(#neonGlow)"/><line x1="68" y1="68" x2="86" y2="88" stroke="#005566" stroke-width="8" stroke-linecap="round"/><line x1="68" y1="68" x2="86" y2="88" stroke="url(#neonGradient)" stroke-width="6" stroke-linecap="round" filter="url(#neonGlow)"/></svg>'
  },
  favicons: {
