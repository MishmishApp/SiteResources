var resources = {
  ...
  icons: {
    ...
    byteslogo: '<svg xmlns="http://www.w3.org/2000/svg" stroke="#880E4F" viewBox="0 0 100 100"><circle cx="50" cy="50" r="30" stroke-width="5" fill="none"/><path d="M46 30 V70" stroke-width="5" stroke-linecap="round"/><path d="M40 30 V50" stroke-width="5" stroke-linecap="round"/><path d="M52 30 V50" stroke-width="5" stroke-linecap="round"/><path d="M59 30 V70" stroke-width="5" stroke-linecap="round"/><path d="M58 30 V50" stroke-width="5" stroke-linecap="round"/>    <path d="M60 30 V50" stroke-width="5" stroke-linecap="round"/></svg>',
