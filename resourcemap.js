var resources = {
  misc: {
    ...
    cookiejar: 'https://cdn.jsdelivr.net/gh/MishmishApp/SiteResources/images/cookiejar.png'
  },
  icons: {
    ...
    collapsedown: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.59,5.59L18,7L12,13L6,7L7.41,5.59L12,10.17L16.59,5.59M16.59,11.59L18,13L12,19L6,13L7.41,11.59L12,16.17L16.59,11.59Z" /></svg>',
    collapseup: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M7.41,18.41L6,17L12,11L18,17L16.59,18.41L12,13.83L7.41,18.41M7.41,12.41L6,11L12,5L18,11L16.59,12.41L12,7.83L7.41,12.41Z" /></svg>',
    ...
    boomkinglogo: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="4 4 56 56" fill="none"><rect x="4" y="4" width="56" height="56" rx="10" fill="#003580"/><path d="M12 50V16C12 15 13 14 14 14H50C51 14 52 15 52 16V50" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 50H56" stroke="white" stroke-width="3" stroke-linecap="round"/><rect x="18" y="24" width="8" height="8" stroke="white" stroke-width="3" stroke-linejoin="round"/><rect x="38" y="24" width="8" height="8" stroke="white" stroke-width="3" stroke-linejoin="round"/><rect x="28" y="40" width="8" height="10" stroke="white" stroke-width="3" stroke-linejoin="round"/></svg>',
    byteslogo: '<svg xmlns="http://www.w3.org/2000/svg" stroke="#880E4F" viewBox="0 0 66 66"><circle cx="33" cy="33" r="30" stroke-width="5" fill="none"/><path d="M28 14 V54" stroke-width="5" stroke-linecap="round"/><path d="M22 14 V34" stroke-width="5" stroke-linecap="round"/><path d="M34 14 V34" stroke-width="5" stroke-linecap="round"/><path d="M43 14 V54" stroke-width="5" stroke-linecap="round"/><path d="M42 14 V34" stroke-width="5" stroke-linecap="round"/><path d="M44 14 V34" stroke-width="5" stroke-linecap="round"/></svg>',
    quiklogo: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><filter id="neonGlow" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur stdDeviation="4.5" result="blurred"/><feFlood flood-color="#00FFEC" result="glowColor"/><feComposite in="glowColor" in2="blurred" operator="in" result="glow"/><feMerge><feMergeNode in="glow"/><feMergeNode in="glow"/><feMergeNode in="SourceGraphic"/></feMerge></filter><linearGradient id="neonGradient" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#00D4FF"/><stop offset="100%" stop-color="#00FFEC"/></linearGradient></defs><circle cx="50" cy="50" r="48" fill="black"/><circle cx="50" cy="50" r="30" stroke="#003344" stroke-width="16" fill="none"/><circle cx="50" cy="50" r="30" stroke="url(#neonGradient)" stroke-width="14" fill="none" filter="url(#neonGlow)"/><line x1="54" y1="54" x2="84" y2="84" stroke="black" stroke-width="24" stroke-linecap="round"/><line x1="54" y1="54" x2="84" y2="84" stroke="url(#neonGradient)" stroke-width="14" stroke-linecap="round" filter="url(#neonGlow)"/></svg>',
    send: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M2,21L23,12L2,3V10L17,12L2,14V21Z" /></svg>',
    emojis: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12M22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2A10,10 0 0,1 22,12M10,9.5C10,10.3 9.3,11 8.5,11C7.7,11 7,10.3 7,9.5C7,8.7 7.7,8 8.5,8C9.3,8 10,8.7 10,9.5M17,9.5C17,10.3 16.3,11 15.5,11C14.7,11 14,10.3 14,9.5C14,8.7 14.7,8 15.5,8C16.3,8 17,8.7 17,9.5M12,17.23C10.25,17.23 8.71,16.5 7.81,15.42L9.23,14C9.68,14.72 10.75,15.23 12,15.23C13.25,15.23 14.32,14.72 14.77,14L16.19,15.42C15.29,16.5 13.75,17.23 12,17.23Z" /></svg>',
    cursor: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M13.64,21.97C13.14,22.21 12.54,22 12.31,21.5L10.13,16.76L7.62,18.78C7.45,18.92 7.24,19 7,19A1,1 0 0,1 6,18V3A1,1 0 0,1 7,2C7.24,2 7.47,2.09 7.64,2.23L7.65,2.22L19.14,11.86C19.57,12.22 19.62,12.85 19.27,13.27C19.12,13.45 18.91,13.57 18.7,13.61L15.54,14.23L17.74,18.96C18,19.46 17.76,20.05 17.26,20.28L13.64,21.97Z" /></svg>',
